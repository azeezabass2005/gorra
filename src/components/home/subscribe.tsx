      ...
      <div className='flex flex-col justify-center items-center max-w-[1000px] sm:px-10 px-4 pb-10 md:gap-10 gap-8'>
        ...
        <div className='flex flex-col ss:gap-5 gap-4 justify-center items-center w-fit rounded-2xl bg-white shadow-md ss:py-5 py-4 ss:px-8 px-4'>
          <div className='flex flex-col ss:gap-1 justify-center items-center max-w-[500px]'>
            <h3 className='ss:text-[20px] text-[19px] font-semibold text-center'>
              Would you love to hear more Gorra related and hat related news?
            </h3>
            <p className='text-[var(--grey-text)] text-center ss:text-[16px] text-[15px]'>
              If yes, a subscription to our news letter can keep you updated about latest trends.
            </p>
          </div>
          <div className='drop-shadow-md border-[1px] focus-within:border-[1.5px] border-primary p-1 rounded-2xl bg-[var(--pure-white)] ss:w-[400px] vs:w-[300px] w-[260px] flex justify-between items-center'>
            <input type='email' className='py-1 px-2 text-[15px] outline-none border-none bg-[var(--pure-white)]' placeholder='Subscribe to Gorra...' />
